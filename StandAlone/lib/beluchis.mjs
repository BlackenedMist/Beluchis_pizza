...
export class Upstream {
  ...
  // Public shop hours/status used to pace polling when the shop is closed.
  // No session needed; a 401 here still triggers a normal login+retry.
  async fetchShopStatus() {
    return this.request('/api/shop/config', { method: 'GET' });
  }
}